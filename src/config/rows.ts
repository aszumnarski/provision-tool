...
export const actions = {columns: [c.empty, c.empty, c.stateControllerButton] };

export const general = {
  title: "GENERAL INFORMATION",
  columns: [c.generalLeft, c.generalMiddle, c.generalRight],
};
...
export const classification = {
  ...
  columns: [
    c.classificationLeft,
    c.classificationMiddle,
    c.classificationRight,
  ],
};
...
export const controls = {
  columns: [c.attach, c.empty, c.empty],
};
